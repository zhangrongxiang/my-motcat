...
from utils.file_utils import save_pkl,save_index
...
parser.add_argument('--miss',      type=str, choices=['P','G'],
                    default=None, help='missing modality')
...
def main(args):
    ...
    for i in folds:
        ...
        if args.task_type == 'survival':
            summary_results, print_results = train(datasets, i, args,miss=args.miss) ### new
