...
def train(datasets: tuple, cur: int, args: Namespace,miss=None):
    """   
        ...
        if args.mode == 'coattn':
            if args.model_type == 'mcat':
                ...
                if args.use_micro_batch:
                    ...
                    val_latest, c_index_val, stop = validate_survival_coattn_mb(cur, epoch, args.bs_micro, model, val_loader, args.n_classes, early_stopping, monitor_cindex, writer, loss_fn, reg_fn, args.lambda_reg, args.results_dir,miss, args)
                else:
                    from trainer.coattn_trainer import train_loop_survival_coattn, validate_survival_coattn
                    train_loop_survival_coattn(epoch, model, train_loader, optimizer, args.n_classes, writer, loss_fn, reg_fn, args.lambda_reg, args.gc, args)
                    val_latest, c_index_val, stop = validate_survival_coattn(cur, epoch, model, val_loader, args.n_classes, early_stopping, monitor_cindex, writer, loss_fn, reg_fn, args.lambda_reg, args.results_dir,miss, args)
            ...
            val_latest, c_index_val, stop = validate_survival(cur, epoch, model, val_loader, args.n_classes, early_stopping, monitor_cindex, writer, loss_fn, reg_fn, args.lambda_reg, args.results_dir,miss, args)
